 ...
 *     vogue-layout.c:vogue_layout_line_reorder().
 */
...
/**
 * vogue_reorder_items:
 * @logical_items: (element-type Vogue.Item): a #GList of #VogueItem in logical order.
 *
 * From a list of items in logical order and the associated
 * directional levels, produce a list in visual order.
 * The original list is unmodified.
 *
 * Returns: (transfer full) (element-type Vogue.Item): a #GList
 *          of #VogueItem structures in visual order.
 *
 * (Please open a bug if you use this function.
 *  It is not a particularly convenient interface, and the code
 *  is duplicated elsewhere in Vogue for that reason.)
 */
GList *
vogue_reorder_items (GList *logical_items)
{
