/* Vogue - Internationalized text layout and rendering library
...
#include <vogue/vogue-features.h>
 ...
 * PANGO_VERSION_1_2:
 *
 * A macro that evaluates to the 1.2 version of Vogue, in a format
 ...
 * PANGO_VERSION_1_4:
 *
 * A macro that evaluates to the 1.4 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_6:
 *
 * A macro that evaluates to the 1.6 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_8:
 *
 * A macro that evaluates to the 1.8 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_10:
 *
 * A macro that evaluates to the 1.10 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_12:
 *
 * A macro that evaluates to the 1.12 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_14:
 *
 * A macro that evaluates to the 1.14 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_16:
 *
 * A macro that evaluates to the 1.16 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_18:
 *
 * A macro that evaluates to the 1.18 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_20:
 *
 * A macro that evaluates to the 1.20 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_22:
 *
 * A macro that evaluates to the 1.22 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_24:
 *
 * A macro that evaluates to the 1.24 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_26:
 *
 * A macro that evaluates to the 1.26 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_28:
 *
 * A macro that evaluates to the 1.28 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_30:
 *
 * A macro that evaluates to the 1.30 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_32:
 *
 * A macro that evaluates to the 1.32 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_34:
 *
 * A macro that evaluates to the 1.34 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_36:
 *
 * A macro that evaluates to the 1.36 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_38:
 *
 * A macro that evaluates to the 1.38 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_40:
 *
 * A macro that evaluates to the 1.40 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_42:
 *
 * A macro that evaluates to the 1.42 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.42
 */
 ...
 * PANGO_VERSION_1_44:
 *
 * A macro that evaluates to the 1.44 version of Vogue, in a format
 * that can be used by the C pre-processor.
 *
 * Since: 1.44
 */
 ...
 * the vogue.h header.
 * The definition should be one of the predefined Vogue version
 * macros: %PANGO_VERSION_1_2, %PANGO_VERSION_1_4,...
 *
 * This macro defines the earliest version of Vogue that the package is
 ...
 * macros: %PANGO_VERSION_1_2, %PANGO_VERSION_1_4,...
 *
 * This macro defines the latest version of the Vogue API that the
 ...
 * different code depending on the Vogue version, then this should be
...
/* These macros are used to mark deprecated functions in Vogue headers,
